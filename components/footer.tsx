    ...
    >
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">KIITease</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Making student life at KIIT University easier and more efficient.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            &copy; {currentYear} KIITease. All rights reserved.
          </p>
